...
var _a;
var _this = this;
(_a = document.getElementById('contact-form')) === null || _a === void 0 ? void 0 : _a.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
    var name, email, contactNumber, subject, message, formData, response, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 6, , 7]);
                return [4 /*yield*/, fetch('https://6715fa9133bc2bfe40bbcc65.mockapi.io/xyz', {
                        method: 'POST',
                        headers: {
            ...
            case 2:
                response = _a.sent();
                alert('It might take some time for the response from MockAPI. Please wait.');
